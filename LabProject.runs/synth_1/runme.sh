...
HD_PWD='C:/Users/ozlem/Desktop/vivado/LabProject/LabProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log user_Interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source user_Interface.tcl
