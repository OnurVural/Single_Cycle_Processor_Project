...
HD_PWD='C:/Users/ozlem/Desktop/vivado/LabProject/LabProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log user_Interface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source user_Interface.tcl -notrace
